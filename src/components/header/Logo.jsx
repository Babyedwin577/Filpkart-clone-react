...
export const Logo = () => {
  return (
    <div className="header">
        <div className='logo'>
          <a href="https://www.flipkart.com" className='burger-nav'>
